...
#### LeNet-5 on MNIST-10
|层  |剪枝率|首次测试|首次迭代|acc|迭代次数|学习率|学习率衰减|batch|
|:---|:-----|:-------|:------|:-------|:------|:-----|:--------|:---------|
...
|FC  |50%   |0.9832|0.9878 |        |       |0.001 |0.1/50epoch|128|
...
|层  |剪枝率|首次测试|首次迭代|acc|迭代次数|学习率|学习率衰减|batch|备注|
|:---|:-----|:------|:--------|:-------|:------|:-----|:--------|:---------|:---|
...
#### VGG-16 on CIFAR-10
|层  |剪枝率|首次测试|acc|迭代次数|学习率|学习率衰减|batch|备注|
|:---|:-----|:------|:-------|:------|:-----|:--------|:---------|:--|
|    |0%    |/      |  |       |      |         |16||
|Conv|50%   |       |  |     |       |      |         |16|
...
#### LeNet-5 on MNIST-10
|剪枝率|首次测试|acc|迭代次数|学习率|学习率衰减|batch|
|:-----|:------|:-------|:------|:-----|:--------|:---------|
